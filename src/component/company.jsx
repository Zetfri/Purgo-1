        ...
        <div>
            <div className='w-full h-[550px] flex sm:flex-col bg-[#E3E3E3] px-10 sm:px-4 sm:gap-4 sm:h-auto sm:py-10'>
                <div className='w-[50%] h-full sm:w-full flex flex-col px-10 pt-20 sm:px-0 sm:pt-0'>
                    ...
                    <p className='text-[25px] w-[500px] sm:w-full font-light sm:mt-2' style={{ lineHeight: "36.63px"}}>Компания <span className='text-[#292AFF]' style={{fontWeight: "300"}}>Purgo</span> Профессионально на высоком уровне качества выполняет все виды сантехнических работ в Ангрене и Ташкентской области.</p>
                </div>
