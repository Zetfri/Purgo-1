      ...
      >
        ...
        <div className="w-full h-full flex justify-center items-center">
          <div className="w-[50%] h-full pt-20 flex flex-col justify-start items-center sm:w-full sm:pt-10">
            <h1 className="text-white text-[60px] w-[636px] tracking-[-5px] sm:w-full sm:text-[50px] sm:px-4">
            ...
            <p className="text-white text-[24px] mt-20 ml-[-160px] w-[450px] tracking-[-2px] sm:ml-0 sm:w-full sm:px-4 sm:mt-10">
